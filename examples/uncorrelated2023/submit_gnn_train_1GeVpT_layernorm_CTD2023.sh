...
#SBATCH -o /scratch/bbhj/jareddb2/GNN4ITk/commonframework_data_output/uncorrelated2023/job_logs/job_gnn_train_1GeVpT_layernorm_CTD2023.out
#SBATCH -e /scratch/bbhj/jareddb2/GNN4ITk/commonframework_data_output/uncorrelated2023/job_logs/job_gnn_train_1GeVpT_layernorm_CTD2023.err
...
## GNN Train
start=`date +%s`
srun g4i-train gnn_train_1GeVpT_layernorm_CTD2023.yaml --checkpoint='/scratch/bbhj/jareddb2/GNN4ITk/commonframework_data_output/uncorrelated2023/gnn_1GeVpT_layernorm_CTD2023/artifacts/last--v1.ckpt'
end=`date +%s`
time_diff=$(($end-$start-18*3600))
echo "gnn_train.yaml Elapsed Time: `date -d @$time_diff +%H:%M:%S`" >> /scratch/bbhj/jareddb2/GNN4ITk/commonframework_data_output/uncorrelated2023/job_logs/job_train_1GeVpT_layernorm_CTD2023.out
